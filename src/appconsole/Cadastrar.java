    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (opc == 1) {
                ...
                db.store(v);
                db.commit();
                System.out.println("Vacina '" + nome + "' cadastrada com id=" + v.getId()); 
                ...
                if (ps.isEmpty()) {
                    ...
                    if (vacs.isEmpty()){
                         System.out.println("Nenhuma vacina cadastrada. Cadastre uma vacina primeiro.");
                         return; 
                    }
                    ...
                    if(resultVac.isEmpty()){ 
                         System.out.println("Vacina com id=" + idVac + " não encontrada.");
                    } else {
                        Vacina vacinaEscolhida = resultVac.next(); 
